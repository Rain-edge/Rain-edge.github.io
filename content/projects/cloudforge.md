...
date: 2026-05-01 10:00:00+08:00
draft: false
...
features:
- 基于 FastAPI 的后端服务，Docker 容器化部署
- Helm Chart 打包，GitOps 方式通过 ArgoCD 自动部署
- Prometheus + Grafana 监控告警，Loki 日志聚合，Tempo 链路追踪
- CI 流水线：代码推送自动构建镜像并触发部署
process: 项目从 2026 年 3 月开始，先搭基础设施（K8s 集群、Ingress、存储），然后逐个接入可观测性组件，最后用 ArgoCD 把整个部署流程
  GitOps 化。
