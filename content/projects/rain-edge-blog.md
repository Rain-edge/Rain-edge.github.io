...
features = ['GitHub Actions 推送即部署，零手动操作', '站内全文搜索、标签、归档、分类体系', '明暗双主题，逐字动画标题', 'Moments 轻量日常流与 Projects 项目展示']
process = '选型对比 Jekyll/Hugo/Hexo 后选定 Hugo；锁定 PaperMod v8.0 主题；站点层覆盖实现自定义样式与动画；GitHub Actions 双 Job 流水线自动构建部署。'
